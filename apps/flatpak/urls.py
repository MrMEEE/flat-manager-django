...
urlpatterns = [
    ...
    path('builds/<int:pk>/recommit/', views.BuildRecommitView.as_view(), name='build_recommit'),
    ...
    path('externals/flathub-apps/', views.FlathubAppCatalogView.as_view(), name='flathub_app_catalog'),
    path('externals/flathub-apps/search/', views.FlathubAppSearchView.as_view(), name='flathub_app_search'),
    ...
    path('bst-sources/bulk-action/', views.BuildStreamBulkActionView.as_view(), name='bst_bulk_action'),
